...
function attachFormHandler() {
    ...
    // Set accepted file types programmatically as well
    fileInput.setAttribute('accept', Array.from(allowedTypes).join(','));
    ...
    // File input change handler - additional security check
